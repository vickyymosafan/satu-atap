...
const Hero: React.FC<ThemeProps> = () => {
  ...
  return (
    <section className="relative min-h-screen bg-background pt-16 sm:pt-20 md:pt-24 lg:pt-28 transition-colors duration-300">
        ...
        <div className="lg:hidden">
          ...
          <div className="flex flex-col min-h-[calc(100vh-4rem)] px-4 sm:px-6 py-6 sm:py-8">
            ...
            <div className={`text-center mb-8 transition-all duration-1000 ${
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-card rounded-full border border-border mb-6 shadow-sm">
            ...
            <div className={`grid grid-cols-2 gap-3 mb-8 transition-all duration-1000 delay-200 ${
              ...
              {[
                ...
                <div
                  key={stat.label}
                  className="bg-card p-4 rounded-2xl border border-border text-center shadow-sm"
                >
            ...
            <div className={`mt-auto transition-all duration-1000 delay-500 ${
              ...
              <button
                ...
                className="w-full bg-primary text-primary-foreground font-bold py-4 px-6 rounded-2xl hover:bg-primary/90 transition-all duration-300 shadow-lg hover:shadow-xl transform active:scale-95 mb-4 min-h-[56px] flex items-center justify-center"
              ...
              <button
                ...
                className="w-full border-2 border-primary text-primary font-semibold py-4 px-6 rounded-2xl hover:bg-primary hover:text-primary-foreground transition-all duration-300 min-h-[56px] flex items-center justify-center bg-transparent"
          ...
          <div className="max-w-7xl mx-auto px-8 lg:px-10 xl:px-12 py-16 xl:py-20 flex items-center justify-center min-h-[calc(100vh-6rem)]">
            <div className="grid grid-cols-12 gap-16 items-center w-full">
              ...
              <div className={`col-span-7 flex flex-col justify-center text-left transition-all duration-1000 ${
                ...
                {/* Desktop Trust Badge */}
                <div className="inline-flex items-center gap-2 px-5 py-3 bg-card rounded-full border border-border mb-8 shadow-sm w-fit">
                  <div className="flex items-center gap-1">
                    <Star className="w-4 h-4 text-yellow-500 fill-current" />
                    <Star className="w-4 h-4 text-yellow-500 fill-current" />
                    <Star className="w-4 h-4 text-yellow-500 fill-current" />
                ...
                {/* Desktop Headline */}
                <h1 className="text-6xl xl:text-7xl font-bold text-foreground mb-8 leading-tight tracking-tight">
                  Temukan Kost Impian di{' '}
                  <span className="relative inline-block">
                    <span className="text-muted-foreground transition-all duration-500">
                      {popularLocations[currentLocationIndex]}
                    </span>
                    <div className="absolute -bottom-2 left-0 right-0 h-1.5 bg-accent rounded-full transform scale-x-100 opacity-60"></div>
                  </span>
                </h1>

                {/* Desktop Value Proposition */}
                <p className="text-2xl text-muted-foreground mb-10 leading-relaxed max-w-2xl">
                  Platform terpercaya untuk mencari kost yang{' '}
                  <span className="font-semibold text-foreground">aman, nyaman, dan terjangkau</span>{' '}
                ...
                <div className="grid grid-cols-2 gap-4 mb-10 max-w-2xl">
                  {[
                    ...
                    <div
                      key={benefit.text}
                      className={`flex items-center gap-3 p-4 bg-card rounded-xl border border-border transition-all duration-700 hover:shadow-md ${
                ...
                <div className="flex gap-4">
                  <button
                    onClick={scrollToSearch}
                    className="inline-flex items-center justify-center px-10 py-4 bg-primary text-primary-foreground font-bold rounded-xl hover:bg-primary/90 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95 min-h-[56px]"
                    aria-label="Mulai mencari kost sekarang"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center px-10 py-4 border-2 border-primary text-primary font-semibold rounded-xl hover:bg-primary hover:text-primary-foreground transition-all duration-300 min-h-[56px] bg-transparent"
                    aria-label="Daftar akun gratis"
                  >
              ...
              <div className={`col-span-5 flex flex-col justify-center transition-all duration-1000 delay-300 ${
                ...
                <div className="grid grid-cols-2 gap-5 mb-8">
                  {[
                    ...
                    <div
                      key={stat.label}
                      className={`bg-card p-6 rounded-xl border border-border shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 ${
