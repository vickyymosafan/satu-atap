            ...
            <a
              ...
              className={
                btn.type === 'primary'
                  ...
                  : 'px-6 py-2 rounded-lg font-semibold text-gray-600 dark:text-gray-300 border border-blue-300 dark:border-blue-400 hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-600 hover:text-white hover:border-blue-600 hover:shadow-md transition-all duration-200'
              }
            >
              {btn.label}
            </a>
